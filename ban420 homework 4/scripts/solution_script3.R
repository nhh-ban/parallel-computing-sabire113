...
# Assignment 2:  
# Modify MTweedieTests to use parallel processing
MTweedieTests <- function(N, M, sig) {
  ...
  share_reject <- foreach(i = 1:M, .combine = '+', .packages = "tweedie", .export = c("simTweedieTest")) %dopar% {
